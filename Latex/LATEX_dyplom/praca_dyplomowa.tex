...
\begin{figure}[!htbp]
	\begin{center}
		\centering
		\includegraphics[scale=0.2]{\ImgPath/rys/screenshots/email-not-exist.png}
	\end{center}
...
\begin{figure}[!htbp]
	\begin{center}
		\centering
		\includegraphics[scale=0.2]{\ImgPath/rys/screenshots/after-login.png}
	\end{center}
