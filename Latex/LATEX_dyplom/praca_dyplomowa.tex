...
\begin{enumerate}
	...
	\item Moduł przetwarzania plików pdf - jako jedyny nie będzie odpowiadał za obsługę żądań, a za przetwarzania plików pdf. Będzie dostarczał następujące funkcjonalności:
	\begin{itemize}
